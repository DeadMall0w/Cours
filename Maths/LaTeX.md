...
$\begin{tabular}{|c|c|} \hline Colonne 1 & Colonne 2 \\ \hline Ligne 1 & Donnée 1 \\ Ligne 2 & Donnée 2 \\ \hline \end{tabular}$
$\begin{tabular}{|c|c|} \hline Colonne 1 & Colonne 2 \\ \hline Ligne 1 & Donnée 1 \\ Ligne 2 & Donnée 2 \\ \hline \end{tabular}$

$\begin{bmatrix} 1 & 2 & 3 \\ 4 & 5 & 6 \\ 7 & 8 & 9 \end{bmatrix}$


$\begin{center} \begin{tikzpicture} \begin{axis}[ xlabel={$x$}, ylabel={$y$}, ] \addplot[domain=-5:5, samples=100, color=blue]{x}; \end{axis} \end{tikzpicture} \end{center}$

'''\begin{tikzpicture} \draw (0,0) circle (2cm); \end{tikzpicture}$'''
